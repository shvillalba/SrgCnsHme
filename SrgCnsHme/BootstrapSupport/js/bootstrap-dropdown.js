...
!(function ($) {
  ...
  function getMenu($this) {
    ...
    $('.dropdown-menu', $menu).attr('data-load', $this.attr('data-load')); //SHV: allows passing of data (id, etc.) to menu.
  ...
  function getPosition(e, $this, $menu) {
    ...
    if ($this.attr("data-iterator") == "knockoutarray") { //SHV: otherwise it assumes the event happened on first row of (ko-generated) table, and displays menu always over first row of table.
      posY = mouseY;
      posX = mouseX;
    }
